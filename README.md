# AI Malnutrition Risk Prediction
...
- **Output:** Risk of malnutrition (0 = Not at risk, 1 = At risk)  

The computer learns from examples of children with known risk and predicts for new children.
...
## 🔮 Future Improvements
- Use larger datasets for more accuracy  
- Add multiple risk levels (low, medium, high)  
- Integrate into mobile apps for community workers  
